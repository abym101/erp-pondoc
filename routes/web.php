...
use App\Http\Controllers\ERP\TahfidzController;
use App\Http\Controllers\ERP\AcademicController;
Route::get('/erp/attendance',[AttendanceController::class,'index']);
Route::get('/erp/tahfidz',[TahfidzController::class,'index']);
Route::get('/erp/academic-dashboard',[AcademicController::class,'index']);
use App\Http\Controllers\ERP\WaliSantriController;
use App\Http\Controllers\ERP\TabunganController;
use App\Http\Controllers\ERP\SppController;
use App\Http\Controllers\ERP\KeuanganSantriDashboardController;
Route::get('/erp/wali-santri',[WaliSantriController::class,'index']);
Route::get('/erp/tabungan-santri',[TabunganController::class,'index']);
Route::get('/erp/spp',[SppController::class,'index']);
Route::get('/erp/keuangan-santri-dashboard',[KeuanganSantriDashboardController::class,'index']);
